...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        var isLicenseValid = options && new RegExp('([\\d\\w]{8}-){3}[\\d\\w]{8}|FF1C17F5-6ABA422F-9C92BA40-CB1580CB').test(options.licenseKey) || document.domain.indexOf('alvarotrigo.com') > -1;
